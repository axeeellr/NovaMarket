...
const fruits = 'https://novamarket-img.s3.us-east-2.amazonaws.com/meats.jpg';
...
const Meats = () => {
    ...
    const arrows = [
        ...
        { name: 'Ir a granos', id: 'Adelante', x: 0.63, y: 0.45 },
    ];
                ...
                {arrows
                    ...
                    .map(arrow => (
                        <div
                            key={arrow.id}
                            id={`arrow-${arrow.id}`}
                            className={arrow.id === 'Atrás' ? 'arrow arrowAtras' : 'arrow arrowAdelante arrowGranos'}
                            style={{
                                left: `${arrow.x * 100}%`,
                                top: `${arrow.y * 100}%`,
                            }}
