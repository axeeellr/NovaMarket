...
const fruits = 'https://novamarket-img.s3.us-east-2.amazonaws.com/fruits.jpg';
...
const App = () => {
    ...
    const points = [
        ...
        { name: 'Manzanas', id: 'Manzanas', x: 0.29, y: 0.57 },
        { name: 'Naranjas', id: 'Naranjas', x: 0.32, y: 0.48 },
        { name: 'Mangos', id: 'Mangos', x: 0.9, y: 0.63 },
        { name: 'Rábanos', id: 'Rábanos', x: 0.83, y: 0.56 },
        { name: 'Cilantro', id: 'Cilantros', x: 0.78, y: 0.53 },
        { name: 'Pepinos', id: 'Pepinos', x: 0.84, y: 0.43 },
        { name: 'Papas', id: 'Papas', x: 0.74, y: 0.51 },
    ];
