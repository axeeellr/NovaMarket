...
const Fruits = () => {
    ...
    const PC_COORDS = [
        ...
        { name: 'Tomates', id: 'nm-x-0', shape: 'circle', coords: [100, 360, 10], preFillColor: 'rgba(255, 255, 255, 0.7)', strokeColor: 'black', lineWidth: 5 },
        { name: 'Uvas', id: 'nm-x-0', shape: 'circle', coords: [290, 345, 10], preFillColor: 'rgba(255, 255, 255, 0.7)', strokeColor: 'black', lineWidth: 5 },
    ...
    const MOBILE_COORDS = [
        ...
        { name: 'Tomates', id: 'nm-x-0', shape: 'circle', coords: [100, 430, 10], preFillColor: 'rgba(255, 255, 255, 0.7)', strokeColor: 'black', lineWidth: 5 },
