...
const AdminNotifications = () => {
    ...
    useEffect(() => {
        ...
        const fetchPublishedNotifications = async () => {
            try {
                const response = await axios.get('https://novamarketbackend.onrender.com/published-notifications');
    ...
    const handleAddNotification = async (e) => {
        ...
        try {
            await axios.post('https://novamarketbackend.onrender.com/publish-notification', {
    ...
    const handleDeleteNotification = async (id, type) => {
        if (type === 'default') {
            ...
            try {
                await axios.delete(`https://novamarketbackend.onrender.com/delete-notification/${id}`);
            } catch (error) {
