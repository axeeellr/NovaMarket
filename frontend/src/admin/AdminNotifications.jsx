...
const AdminNotifications = () => {
    ...
    useEffect(() => {
        ...
        const fetchPublishedNotifications = async () => {
            try {
                const response = await axios.get('http://localhost:1001/published-notifications');
    ...
    const handleAddNotification = async (e) => {
        ...
        try {
            await axios.post('http://localhost:1001/publish-notification', {
    ...
    const handleDeleteNotification = async (id, type) => {
        if (type === 'default') {
            ...
            try {
                await axios.delete(`http://localhost:1001/delete-notification/${id}`);
            } catch (error) {
