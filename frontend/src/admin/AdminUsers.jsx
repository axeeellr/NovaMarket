...
const AdminUsers = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const usersResponse = await axios.get('https://novamarketbackend.onrender.com/users');
                const bannedResponse = await axios.get('https://novamarketbackend.onrender.com/banned-users');
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://novamarketbackend.onrender.com/users/${id}`);
    ...
    const handleBan = async (id) => {
        try {
            ...
            await axios.post('https://novamarketbackend.onrender.com/ban-user', { userId: id });
    ...
    const handleUnban = async (id) => {
        try {
            ...
            await axios.post('https://novamarketbackend.onrender.com/unban-user', { userId: id });
